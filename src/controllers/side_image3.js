...
export async function sideImage3(req, res) {
  try {
    ...
    // slide.addShape(pptx.shapes.OVAL, { x: '6%', y: '62%', w: '0.5%', h: 0.05, line: { color: '000000', width: 1 } , fill: { color: '000000' } });
    ...
    // slide.addShape(pptx.shapes.OVAL, { x: '58.5%', y: '50%', w: '3%', h: 0.3, line: { color: '#7d7bec', width: 1 } , fill: { color: '#7d7bec' } });

    // slide.addShape(pptx.shapes.OVAL, { x: '94%', y: '10%', w: '2%', h: 0.2, line: { color: '#7d7bec', width: 1 } , fill: { color: '#7d7bec' } });
