...
function createPrompt(slideTitle, slideDesc) {
  ...
  f)'prosimage' - a string keyword related to the subtitle. This will be used for image search on google keep it short.
  g)'consimage' - a string keyword related to the subtitle. This will be used for image search on google keep it short.`;
...
export async function prosCons2(req, res) {
  try {
    ...
    let prosimage = parsedJson.prosimage;
    let consimage = parsedJson.consimage;
    ...
    if (presentationTitle === undefined || presentationTitle === "" || prosTitle === undefined || prosTitle === "" || consTitle === undefined || consTitle === "" || prosimage === undefined || prosimage === "" || consimage === undefined || consimage === "" || pros1 === undefined || pros1 === "" || pros2 === undefined || pros2 === "" || pros3 === undefined || pros3 === "" || cons1 === undefined || cons1 === "" || cons2 === undefined || cons2 === "") {
      return res.status(500).json({
        status: "error",
        message: "Something is missing"
      })
    ...
    var customJSON = {
      ...
      "prosimage": parsedJson.prosimage ? parsedJson.prosimage : "",
      "consimage": parsedJson.consimage ? parsedJson.consimage : ""
    }
