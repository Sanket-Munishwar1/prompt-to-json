...
export async function sideImage6(req, res) {
  try {
    ...
    // slide.addShape(pptx.shapes.OVAL, { x: '8%', y: '37%', w: '0.5%', h: 0.05, line: { color: '000000', width: 1 } , fill: { color: '000000' } });
    ...
    // slide.addShape(pptx.shapes.OVAL, { x: '8%', y: '47%', w: '0.5%', h: 0.05, line: { color: '000000', width: 1 } , fill: { color: '000000' } });
    ...
    // slide.addShape(pptx.shapes.OVAL, { x: '8%', y: '57%', w: '0.5%', h: 0.05, line: { color: '000000', width: 1 } , fill: { color: '000000' } });
    ...
    // slide.addShape(pptx.shapes.OVAL, { x: '8%', y: '67%', w: '0.5%', h: 0.05, line: { color: '000000', width: 1 } , fill: { color: '000000' } });
