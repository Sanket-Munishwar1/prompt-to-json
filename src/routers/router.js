...
import { sideImage11 } from "../controllers/side_image11.js";
import { sideImage12 } from "../controllers/side_image12.js";
...
router.post("/side-image11",sideImage11 );
router.post("/side-image12",sideImage12 );
